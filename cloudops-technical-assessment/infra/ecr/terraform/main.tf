...
resource "aws_ecr_repository" "order_history" {
  name                 = "${var.environment}-order-history-service"
  image_tag_mutability = "IMMUTABLE"
  force_delete         = true
...
resource "aws_ecr_lifecycle_policy" "order_history_policy" {
  repository = aws_ecr_repository.order_history.name
